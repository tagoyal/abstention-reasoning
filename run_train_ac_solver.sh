...
python -m pipeline train_sft \
  ...
  --dataset "artifacts/${TASK}/sft_datasets/sft_train__method_ac_v2.json"
...
python -m pipeline train_rl \
  ...
  --train-prompts "artifacts/${TASK}/problems_with_format_v2/rl_train__method_ac.parquet" \
  --val-prompts "artifacts/${TASK}/problems_with_format_v2/rl_val__method_ac.parquet" \
  --overwrite
